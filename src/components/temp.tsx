  ...
  return (
    <React.Fragment>
        ...
        <div className='w-full pr-4'>
            ...
            <p className='text-[14px] font-semibold mt-8'>Color</p>
                    ...
                    <>
                        {AvailableColors.map((color:any) => (
                            <div key={color.color} className={`inline-flex w-[25px] h-[25px] mr-[8px] ${SelectedColor === color.color ?'border border-gray-600 p-[2px]' : ''} justify-center items-center text-center rounded-full `}>
                                <button className={` bg-${color.colorCode.slice(1)} inline-block text-black text-center w-[18px] h-[18px] rounded-full transition-all duration-500 ease-in-out 
                                `}
            ...
            <div className='w-full justify-center items-center text-center pt-4'>
                <button onClick={() => onAdd(saleData, CurrentProductId, 1, SelectedColor, selectedSize)} className="group relative rounded-full min-h-[64px] w-[80%] overflow-hidden border border-white bg-black text-white transition-all before:absolute before:left-0 before:top-0 before:h-0 before:w-1/4 before:bg-[#f2f2f2] before:duration-500 after:absolute after:bottom-0 after:right-0 after:h-0 after:w-1/4 after:bg-[#f2f2f2] after:duration-500 hover:text-black hover:before:h-full hover:after:h-full">
