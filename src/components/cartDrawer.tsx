...
const CartDrawer = () => {
  ...
  return (
    <React.Fragment>
      <div className='relative h-full w-full bg-[#f2f2f2]'>
                  ...
                  {(imageGroup.color.color === sale.color) && (
                        <div className='mb-2' key={sale.product_id}>
                          ...
                          <div className='flex items-center sm:space-x-4 w-full'>
                              <Image src={imageGroup.imagesUrls[2]} alt='' width={100} height={100} className='w-36 h-36'style={{objectFit:"cover"}} unoptimized />
        ...
        <div className='justify-center items-center text-center absolute bottom-0 w-full'>
          ...
          <button onClick={() => setIsCartOpen(false)} className="group relative bottom-2 min-h-[76px] w-[96%] overflow-hidden border border-black bg-[#f2f2f2] text-black transition-all before:absolute before:left-0 before:top-0 before:h-0 before:w-1/4 before:bg-black before:duration-500 after:absolute after:bottom-0 after:right-0 after:h-0 after:w-1/4 after:bg-black after:duration-500 hover:text-white hover:before:h-full hover:after:h-full">
          ...
          <button disabled={true} className="group relative bottom-0  min-h-[86px] w-[100%] overflow-hidden border border-black bg-black text-white transition-all before:absolute before:left-0 before:top-0 before:h-0 before:w-1/4 before:bg-[#f2f2f2] before:duration-500 after:absolute after:bottom-0 after:right-0 after:h-0 after:w-1/4 after:bg-[#f2f2f2] after:duration-500 hover:text-black hover:before:h-full hover:after:h-full">
